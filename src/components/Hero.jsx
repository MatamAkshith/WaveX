                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
                    ...
                    <div className="lg:col-span-6 flex flex-col items-center lg:items-start text-center lg:text-left">
                        ...
                        >
                            ...
                            <span className="text-xs font-semibold text-violet-300">DecisionOS v1.0 - Now Public</span>
                        </motion.div>
                        ...
                        >
                            DecisionOS combines company context, AI specialists, startup knowledge, and organizational memory to help founders make confident, executive-level business decisions.
                        </motion.p>
