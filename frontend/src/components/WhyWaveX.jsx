...
export default function WhyWaveX() {
    const cards = [
        {
            badge: 'Context First',
            title: 'Not Just ChatGPT',
            description: "Generic AI chatbots lack local alignment. WaveX models your cap table, burn models, active board decks, and strategy specs to answer queries in complete context.",
            icon: Network,
    ...
    return (
        <section id="why-wavex" className="py-32 relative bg-[#0B0B0B]">
            <div className="max-w-7xl mx-auto px-6 relative z-10">
                ...
                <div className="max-w-3xl mb-20">
                    ...
                    <p className="text-gray-400 text-lg">
                        Unlike simple utility wrappers, WaveX is designed as a structured ecosystem focused on deep reasoning and organizational long-term consistency.
                    </p>
                </div>
