            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-8 mb-16">
                    ...
                    <div className="lg:col-span-2 flex flex-col items-start gap-4">
                        <a href="#" className="flex items-center">
                            <img 
                                src={wavexLogo} 
                                alt="WaveX Logo" 
                                className="h-8 w-8 object-cover rounded-lg shadow-md shadow-blue-500/10" 
                            />
                        </a>

                        <p className="text-gray-400 text-sm max-w-sm leading-relaxed">
                            WaveX is the AI-powered Decision Operating System that equips startup founders with structured advice, specialist debate models, and perpetual organizational memory.
                        </p>
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            <li>
                                <a href="#why-wavex" className="text-sm text-gray-400 hover:text-white transition-colors">About Us</a>
                            </li>
                            <li>
                                <a href="#" className="text-sm text-gray-400 hover:text-white transition-colors flex items-center gap-1.5">
                                    Careers
                ...
                <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
                    <p className="text-xs text-gray-500">
                        &copy; {currentYear} WaveX Technologies Inc. All rights reserved.
                    </p>
